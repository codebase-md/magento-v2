    ...
    function (Component, unzerDirectRedirect) {
        ...
        return Component.extend({
            ...
            getPaymentLogo: function () {
                return window.checkoutConfig.payment.unzerdirect_applepay.paymentLogo;
            },
            getInstructions: function () {
                return window.checkoutConfig.payment.unzerdirect_applepay.instructions;
            }
        });
    }
);